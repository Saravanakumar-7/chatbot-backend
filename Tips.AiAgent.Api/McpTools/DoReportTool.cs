...
{
    [McpServerToolType]
    public class DoReportTool
    {
        [McpServerTool, Description("Fetches the Delivery Order report from the database by calling the Delivery_Order_Report_withparameter_tras stored procedure. Returns report data as JSON.")]
        public static async Task<string> DoReport(
            ...
            string? projectNumber = null)
        {
            ...
            using var command = new MySqlCommand("tras_getapcs_warehouse.Delivery_Order_Report_withparameter_tras", connection);
