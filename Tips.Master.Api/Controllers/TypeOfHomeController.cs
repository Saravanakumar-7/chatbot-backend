...
namespace Tips.Master.Api.Controllers
{
    ...
    public class TypeOfHomeController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetTypeOfHomeById(int id)
        {
            ...
            {
                _logger.LogError($"Something went wrong inside GettypeOfHomeById action: {ex.Message}");
                serviceResponse.Data = null;
        ...
        public IActionResult CreateTypeOfHome([FromBody] TypeOfHomePostDto typeOfHomePostDto)
        {
            ...
            catch (Exception ex)
            {
                ...
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.BadRequest;
                _logger.LogError($"Something went wrong inside CreatetypeOfHome action: {ex.Message}");
                return StatusCode(500, serviceResponse);
            }
        }
        ...
        public async Task<IActionResult> UpdateTypeOfHome(int id, [FromBody] TypeOfHomeUpdateDto typeOfHomeUpdateDto)
        {
            ...
            catch (Exception ex)
            {
                ...
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                _logger.LogError($"Something went wrong inside UpdateTypeOfHome action: {ex.Message}");
                return StatusCode(500, serviceResponse);
            }
        }
        ...
        public async Task<IActionResult> ActivateTypeOfHome(int id)
        {
            ...
            catch (Exception ex)
            {
                ...
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                _logger.LogError($"Something went wrong inside ActivateTypeOfHome action: {ex.Message}");
                return StatusCode(500, serviceResponse);
            }
        }
        [HttpPut("{id}")]
        public async Task<IActionResult> DeactivateTypeOfHome(int id)
        {
            ...
            catch (Exception ex)
            {
                ...
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.BadRequest;
                _logger.LogError($"Something went wrong inside DeactivatedtypeOfHome action: {ex.Message}");
                return StatusCode(500, serviceResponse);
            }
        }
    }
