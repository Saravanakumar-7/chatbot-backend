...
namespace Tips.Master.Api.Controllers
{
    ...
    public class IssuingStockController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetIssuingStockById(int id)
        {
            ...
            {
                _logger.LogError($"Something went wrong inside GetIssuingStockById action: {ex.Message}");
                serviceResponse.Data = null;
        ...
        public IActionResult CreateIssuingStock([FromBody] IssuingStockPostDto IssuingStockPost)
        {
            ...
            catch (Exception ex)
            {
                ...
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.BadRequest;
                _logger.LogError($"Something went wrong inside CreateIssuingStock action: {ex.Message}");
                return StatusCode(500, serviceResponse);
            }
        }
        ...
        public async Task<IActionResult> UpdateIssuingStock(int id, [FromBody] IssuingStockUpdateDto IssuingStockUpdate)
        {
            ...
            catch (Exception ex)
            {
                ...
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                _logger.LogError($"Something went wrong inside UpdateIssuingStock action: {ex.Message}");
                return StatusCode(500, serviceResponse);
            }
        }
        ...
        public async Task<IActionResult> DeleteIssuingStock(int id)
        {
            ...
            catch (Exception ex)
            {
                ...
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                _logger.LogError($"Something went wrong inside DeleteIssuingStock action: {ex.Message}");
                return StatusCode(500, serviceResponse);
            }
        }
        [HttpPut("{id}")]
        public async Task<IActionResult> ActivateIssuingStock(int id)
        {
            ...
            catch (Exception ex)
            {
                ...
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                _logger.LogError($"Something went wrong inside ActivateIssuingStock action: {ex.Message}");
                return StatusCode(500, serviceResponse);
            }
        }
        [HttpPut("{id}")]
        public async Task<IActionResult> DeactivateIssuingStock(int id)
        {
            ...
            catch (Exception ex)
            {
                ...
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                _logger.LogError($"Something went wrong inside DeactivateIssuingStock action: {ex.Message}");
                return StatusCode(500, serviceResponse);
            }
        }
