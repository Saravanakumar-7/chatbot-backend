...
namespace Tips.Master.Api.Controllers
{
    ...
    public class IncoTermController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllIncoTerms([FromQuery] SearchParames searchParams)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetAllIncoTerms API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetAllIncoTerms API : \n {ex.Message}";
        ...
        public async Task<IActionResult> GetAllActiveIncoTerms([FromQuery] SearchParames searchParams)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetAllActiveIncoTerms API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetAllActiveIncoTerms API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
        ...
        public async Task<IActionResult> GetIncoTermById(int id)
        {
            ...
            {
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetIncoTermById API for the following id : {id} \n {ex.Message} ";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                _logger.LogError($"Error Occured in GetIncoTermById API for the following id : {id} \n {ex.Message} \n{ex.InnerException}");
                return StatusCode(500, serviceResponse);
            }
        }
        ...
        public IActionResult CreateIncoTerm([FromBody] IncoTermPostDto incoTerm)
        {
            ...
            {
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in CreateIncoTerm API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                _logger.LogError($"Error Occured in CreateIncoTerm API : \n {ex.Message} \n{ex.InnerException}");
                return StatusCode(500, serviceResponse);
            }
        }
        ...
        public async Task<IActionResult> UpdateIncoTerm(int id, [FromBody] IncoTermUpdateDto incoTerm)
        {
            ...
            {
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in UpdateIncoTerm API for the following id : {id} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                _logger.LogError($"Error Occured in UpdateIncoTerm API for the following id : {id} \n {ex.Message} \n{ex.InnerException}");
                return StatusCode(500, serviceResponse);
            }
        }
        ...
        public async Task<IActionResult> DeleteIncoTerm(int id)
        {
            ...
            {
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in DeleteIncoTerm API for the following id : {id} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                _logger.LogError($"Error Occured in DeleteIncoTerm API for the following id : {id} \n {ex.Message} \n{ex.InnerException}");
                return StatusCode(500, serviceResponse);
            }
        }
        ...
        public async Task<IActionResult> ActivateIncoTerm(int id)
        {
            ...
            {
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in ActivateIncoTerm API for the following id : {id} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                _logger.LogError($"Error Occured in ActivateIncoTerm API for the following id : {id} \n {ex.Message} \n{ex.InnerException}");
                return StatusCode(500, serviceResponse);
            }
        }
        ...
        public async Task<IActionResult> DeactivateIncoTerm(int id)
        {
            ...
            {
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in DeactivateIncoTerm API for the following id : {id} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                _logger.LogError($"Error Occured in DeactivateIncoTerm API for the following id : {id} \n {ex.Message} \n{ex.InnerException}");
                return StatusCode(500, serviceResponse);
            }
        }
