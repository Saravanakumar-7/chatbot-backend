...
namespace Tips.Master.Api.Controllers
{
    ...
    public class AuditFrequencyController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllAuditFrequencies([FromQuery] SearchParames searchParams)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetAllAuditFrequencies API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetAllAuditFrequencies API : \n {ex.Message}";
        ...
        public async Task<IActionResult> GetAllActiveAuditFrequencies([FromQuery] SearchParames searchParams)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetAllActiveAuditFrequencies API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetAllActiveAuditFrequencies API : \n {ex.Message}";
                serviceResponse.Success = false;
        ...
        public async Task<IActionResult> GetAuditFrequencyById(int id)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetAuditFrequencyById API for the following id: {id} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetAuditFrequencyById API for the following id: {id} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public IActionResult CreateAuditFrequency([FromBody] AuditFrequencyDtoPost auditFrequencyDtoPost)
        {
            ...
            {
                _logger.LogError($"Error Occured in CreateAuditFrequency API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in CreateAuditFrequency API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.BadRequest;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> UpdateAuditFrequency(int id, [FromBody] AuditFrequencyDtoUpdate auditFrequencyDtoUpdate)
        {
            ...
            {
                _logger.LogError($"Error Occured in UpdateAuditFrequency API for the following id: {id} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in UpdateAuditFrequency API for the following id: {id} \n {ex.Message} ";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> DeleteAuditFrequency(int id)
        {
            ...
            {
                _logger.LogError($"Error Occured in DeleteAuditFrequency API for the following id: {id} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in DeleteAuditFrequency API for the following id: {id} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> ActivateAuditFrequency(int id)
        {
            ...
            {
                _logger.LogError($"Error Occured in ActivateAuditFrequency API for the following id: {id} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in ActivateAuditFrequency API for the following id: {id} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> DeactivateAuditFrequency(int id)
        {
            ...
            {
                _logger.LogError($"Error Occured in DeactivateAuditFrequency API for the following id: {id} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in DeactivateAuditFrequency API for the following id: {id} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.BadRequest;
                return StatusCode(500, serviceResponse);
            }
