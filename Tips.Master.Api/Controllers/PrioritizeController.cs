    ...
    public class PrioritizeController : ControllerBase
     {
        ...
        public async Task<IActionResult> GetPrioritizeById(int id)
        {
            ...
            {
                _logger.LogError($"Something went wrong inside GetPrioritizeById action: {ex.Message}");
                serviceResponse.Data = null;
        ...
        public  IActionResult CreatePrioritize([FromBody] PrioritizeDtoPost prioritizeDTOPost)
        {
            ...
            catch (Exception ex)
            {
                ...
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                _logger.LogError($"Something went wrong inside Prioritize action: {ex.Message}");
                return StatusCode(500, serviceResponse);
            }
        }
        ...
        public async Task<IActionResult> UpdatePrioritize(int id, [FromBody] PrioritizeDtoUpdate prioritizeDtoUpdate)
        {
            ...
            catch (Exception ex)
            {
                ...
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                _logger.LogError($"Something went wrong inside UpdatePrioritize action: {ex.Message}");
                return StatusCode(500, serviceResponse);
            }
        }
        ...
        public async Task<IActionResult> DeletePrioritizeById(int id)
        {
            ...
            {
                serviceResponse.Data = null;
                serviceResponse.Message = $"Something went wrong inside DeletePrioritizeById action: {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                _logger.LogError($"Something went wrong inside DeletePrioritizeById action: {ex.Message}");
                return StatusCode(500, serviceResponse);
            }
        }
