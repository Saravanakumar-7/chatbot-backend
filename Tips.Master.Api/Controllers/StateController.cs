    ...
    public class StateController : ControllerBase
    {
        ...
        public async Task<IActionResult> ActivateState(int id)
        {
            ...
            catch (Exception ex)
            {
                ...
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                _logger.LogError($"Something went wrong inside Activatestate action: {ex.Message}");
                return StatusCode(500, serviceResponse);
            }
        }
        [HttpPut("{id}")]
        public async Task<IActionResult> DeactivateState(int id)
        {
            ...
            catch (Exception ex)
            {
                ...
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.BadRequest;
                _logger.LogError($"Something went wrong inside DeactivatedState action: {ex.Message}");
                return StatusCode(500, serviceResponse);
            }
        }
    }
