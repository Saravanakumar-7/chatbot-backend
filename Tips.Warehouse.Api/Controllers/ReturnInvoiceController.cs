...
namespace Tips.Warehouse.Api.Controllers
{
    ...
    public class ReturnInvoiceController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllReturnInvoice([FromQuery] PagingParameter pagingParameter, [FromQuery] SearchParams searchParams)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetAllReturnInvoice API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetAllReturnInvoice API : \n {ex.Message}";
        ...
        public async Task<IActionResult> GetReturnInvoiceById(int id)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetReturnInvoiceById API for the following id:{id} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetReturnInvoiceById API for the following id:{id} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> CreateReturnInvoice([FromBody] ReturnInvoiceDtoPost ReturnInvoiceDtoPost)
        {
                ...
                if (returnInvoiceItemDto != null && returnInvoiceItemDto.Count() > 0)
                {
                    for (int i = 0; i < returnInvoiceItemDto.Count; i++)
                    {
                        ...
                        foreach (var eachbin in returnInvoiceItems.QtyDistribution)
                        {
                            ...
                            inventoryTranctionPost1.Issued_Quantity = inventory.Balance_Quantity;
                            ...
                            inventoryTranctionPost1.GrinNo = inventory.GrinNo;
                            inventoryTranctionPost1.GrinPartId = inventory.GrinPartId;
                            inventoryTranctionPost1.IsStockAvailable = true;
                            inventoryTranctionPost1.Warehouse = inventory.Warehouse;
                            inventoryTranctionPost1.From_Location = "Return Invoice";
                            inventoryTranctionPost1.TO_Location = inventory.Location;
                            inventoryTranctionPost1.PartType = returnInvoiceItemsList[i].PartType;
                            inventoryTranctionPost1.ReferenceID = inventory.ReferenceID;
                            inventoryTranctionPost1.ReferenceIDFrom = "Return Invoice";
                            inventoryTranctionPost1.Remarks = "Return Invoice";
            ...
            {
                _logger.LogError($"Error Occured in CreateReturnInvoice API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in CreateReturnInvoice API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> CreateReturnInvoice_AV([FromBody] ReturnInvoiceDtoPost ReturnInvoiceDtoPost)
        {
            ...
            {
                _logger.LogError($"Error Occured in CreateReturnInvoice_AV API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in CreateReturnInvoice_AV API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> UpdateReturnInvoice(int id, [FromBody] ReturnInvoiceDtoUpdate returnInvoiceDtoUpdate)
        {
            ...
            {
                _logger.LogError($"Error Occured in UpdateReturnInvoice API for the following id:{id} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in UpdateReturnInvoice API for the following id:{id} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
        ...
        public async Task<IActionResult> DeleteReturnInvoice(int id)
        {
            ...
            {
                _logger.LogError($"Error Occured in DeleteReturnInvoice API for the following id:{id} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in DeleteReturnInvoice API for the following id:{id} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetReturnInvoiceSPResport([FromQuery] PagingParameter pagingParameter)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetReturnInvoiceSPResport API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetReturnInvoiceSPResport API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> ReturnInvoiceSPReportDate([FromQuery] DateTime? FromDate, [FromQuery] DateTime? ToDate)
        {
            ...
            {
                _logger.LogError($"Error Occured in ReturnInvoiceSPReportDate API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in ReturnInvoiceSPReportDate API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> ReturnInvoiceSPReportWithParameter([FromBody] ReturnInvoiceSPReportWithParamDTO returnInvoiceSPReportDTO)
        {
            ...
            {
                _logger.LogError($"Error Occured in ReturnInvoiceSPReportWithParameter API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in ReturnInvoiceSPReportWithParameter API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> ReturnInvoiceSPReportWithParameterForTrans([FromBody] ReturnInvoiceSPReportWithParamForTransDTO returnInvoiceSPReportDTO)
        {
            ...
            {
                _logger.LogError($"Error Occured in ReturnInvoiceSPReportWithParameterForTrans API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in ReturnInvoiceSPReportWithParameterForTrans API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetReturnInvoiceNumberList()
        {
            ...
            {
                _logger.LogError($"Error Occured in GetReturnInvoiceNumberList API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetReturnInvoiceNumberList API : \n {ex.Message} ";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        [HttpGet]
        public async Task<IActionResult> GetReturnInvoiceSerialNoDetailByFGItemNoAndBTONo(string itemNumber, string doNumber)
        {
            ServiceResponse<IEnumerable<SerialNoDetailDto>> serviceResponse = new ServiceResponse<IEnumerable<SerialNoDetailDto>>();

            try
            {
                var serialNoDetails = await _returnInvoiceRepository.GetReturnInvoiceSerialNoDetailByFGItemNoAndBTONo(itemNumber, doNumber);
            ...
            {
                _logger.LogError($"Error Occured in GetReturnInvoiceSerialNoDetailByFGItemNoAndBTONo API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetReturnInvoiceSerialNoDetailByFGItemNoAndBTONo API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
