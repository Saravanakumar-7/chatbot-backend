...
namespace Tips.Warehouse.Api.Controllers
{
    ...
    public class InventoryController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetRejectInventorybyGrinNo(string GrinNo)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetRejectInventorybyGrinNo API for the following GrinNo:{GrinNo} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetRejectInventorybyGrinNo API for the following GrinNo:{GrinNo}";
                serviceResponse.Success = false;
        ...
        public async Task<IActionResult> GetAllRejectQtyGRINNumbers()
        {
            ...
            {
                _logger.LogError("Error Occured in GetAllRejectQtyGRINNumbers API:\n" + ex.Message + "\n" + ex.InnerException);
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetAllRejectQtyGRINNumbers API:  \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetInventorybyItemandProject([FromQuery] string itemNumber, [FromQuery] string projectNumber)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetInventorybyItemandProject API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventorybyItemandProject API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetInventorybyItem([FromQuery] string itemNumber)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetInventorybyItem API for the following itemNumber:{itemNumber} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventorybyItem API for the following itemNumber:{itemNumber} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetAllInventory([FromQuery] PagingParameter pagingParameter, [FromQuery] SearchParams searchParams)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetAllInventory API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetAllInventory API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetItemNoByInventoryStock()
        {
            ...
            {
                _logger.LogError($"Error Occured in GetItemNoByInventoryStock API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetItemNoByInventoryStock API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
...

        {
            ...
            {
                _logger.LogError($"Error Occured in GetInventoryDetailsByGrinNoandGrinId API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventoryDetailsByGrinNoandGrinId API : \n {ex.Message} ";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
...

        {
            ...
            {
                _logger.LogError($"Error Occured in GetIQCInventoryDetailsByGrinNoandGrinId API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetIQCInventoryDetailsByGrinNoandGrinId API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetAllIQCInventoryDetailsByGrinNoandGrinId(string GrinNo, int GrinPartsId, string ItemNumber, string ProjectNumber)
        {
            ...
            try
            {
                var getInventoryDetailsByGrinNoandGrinId = await _inventoryRepository.GetAllIQCInventoryDetailsByGrinNoandGrinId(GrinNo, GrinPartsId, ItemNumber, ProjectNumber);
                if (getInventoryDetailsByGrinNoandGrinId == null)
                {
                    serviceResponse.Data = null;
                    serviceResponse.Message = $"Inventory with id: {GrinNo}, hasn't been found in db.";
            ...
            {
                _logger.LogError($"Error occured in GetAllIQCInventoryDetailsByGrinNoandGrinId:\n{ex.Message}\n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error occured in GetAllIQCInventoryDetailsByGrinNoandGrinId:\n{ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetIQCItemInventoryDetailsByGrinNoandGrinId(string GrinNo, int GrinPartsId, string ItemNumber)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetIQCItemInventoryDetailsByGrinNoandGrinId API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetIQCItemInventoryDetailsByGrinNoandGrinId API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
...

        {
            ...
            {
                _logger.LogError($"Error Occured in GetOPGIQCInventoryDetailsByGrinNoandGrinId API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetOPGIQCInventoryDetailsByGrinNoandGrinId API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
...

        {
            ...
            {
                _logger.LogError($"Error Occured in GetInventoryItemNoAndDescriptionListByProjectNo API for the following projectNumber:{projectNumber} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventoryItemNoAndDescriptionListByProjectNo API for the following projectNumber:{projectNumber} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
...

        {
            ...
            {
                _logger.LogError($"Error Occured in GetInventoryItemNoAndDescriptionList API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventoryItemNoAndDescriptionList API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
...

        {
            ...
            {
                _logger.LogError($"Error Occured in GetInventoryDetailsByItemnumberandLocation API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventoryDetailsByItemnumberandLocation API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
...

        {
            ...
            {
                _logger.LogError($"Error Occured in GetInventoryDetailsByGrinNo API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventoryDetailsByGrinNo API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetInventoryDetailsByItemAndProjectNo(string itemNumber, string projectNumber)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetInventoryDetailsByItemAndProjectNo API for the following itemNumber:{itemNumber} and projectNumber : {projectNumber} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventoryDetailsByItemAndProjectNo API for the following itemNumber:{itemNumber} and projectNumber : {projectNumber} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetInventoryStockByItemAndShopOrderNo([FromQuery] string itemNumber, [FromQuery] string shopordernumber)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetInventoryStockByItemAndShopOrderNo API for the following itemNumber:{itemNumber} and shopordernumber : {shopordernumber} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventoryStockByItemAndShopOrderNo API for the following itemNumber:{itemNumber} and shopordernumber : {shopordernumber} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetFGInventoryStockByItem([FromQuery] string itemNumber)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetFGInventoryStockByItem API for the following itemNumber:{itemNumber} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetFGInventoryStockByItem API for the following itemNumber:{itemNumber} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetSAInventoryStockByItem([FromQuery] string itemNumber)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetSAInventoryStockByItem API for the following itemNumber:{itemNumber} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetSAInventoryStockByItem API for the following itemNumber:{itemNumber} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetInventoryStockByItemAndProjectNo(string itemNumber, string projectNumber)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetInventoryStockByItemAndProjectNo API for the following itemNumber:{itemNumber} and projectNumber : {projectNumber} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventoryStockByItemAndProjectNo API for the following itemNumber:{itemNumber} and projectNumber : {projectNumber} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetAvailableStockQtyForSalesOrderItems([FromQuery] string salesOrderNo, [FromQuery] int salesOrderStatus, [FromBody] List<string> itemNumberList)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetAvailableStockQtyForSalesOrderItems API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetAvailableStockQtyForSalesOrderItems API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetStockDetailsForAllLocationWarehouseByItemNo(string itemNumber)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetStockDetailsForAllLocationWarehouseByItemNo API for the following itemNumber:{itemNumber} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetStockDetailsForAllLocationWarehouseByItemNo API for the following itemNumber:{itemNumber} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetStockDetailsForAllLocationWarehouseByItemNoAndProjectNo(string itemNumber, string projectNo)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetStockDetailsForAllLocationWarehouseByItemNoAndProjectNo API for the following itemNumber:{itemNumber} and projectNo : {projectNo} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetStockDetailsForAllLocationWarehouseByItemNoAndProjectNo API for the following itemNumber:{itemNumber} and projectNo : {projectNo} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<ActionResult<IEnumerable<ConsumptionReport>>> CoverageReport()
        {
            ...
            {
                _logger.LogError($"Error Occured in CoverageReport API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in CoverageReport API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetInventoryDetailsByItemNo(string itemNumber, string projectNo)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetInventoryDetailsByItemNo API for the following itemNumber:{itemNumber} and projectNo : {projectNo} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventoryDetailsByItemNo API for the following itemNumber:{itemNumber} and projectNo : {projectNo} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetInventoryBySAItemNo(string itemNumber)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetInventoryBySAItemNo API for the following itemNumber:{itemNumber} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventoryBySAItemNo API for the following itemNumber:{itemNumber} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetInventoryByItemNo(string itemNumber)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetInventoryByItemNo API for the following itemNumber:{itemNumber} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventoryByItemNo API for the following itemNumber:{itemNumber} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetConsumptionInventoryByItemNotest1(List<string> itemNumberList)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetConsumptionInventoryByItemNotest1 API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetConsumptionInventoryByItemNotest1 API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetConsumptionInventoryByItemAndProjectNotest2(List<InventoryItemNoAndProjectNoDto> ItemNoAndProjectNoList)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetConsumptionInventoryByItemAndProjectNotest2 API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetConsumptionInventoryByItemAndProjectNotest2 API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetConsumptionInventoryByItemNo(string itemNumber)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetConsumptionInventoryByItemNo API for the following itemNumber:{itemNumber} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetConsumptionInventoryByItemNo API for the following itemNumber:{itemNumber} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetConsumptionChildItemStockWithWipQty(List<string> itemNumberList)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetConsumptionChildItemStockWithWipQty API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetConsumptionChildItemStockWithWipQty API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetConsumptionChildItemStockWithWipQtyByProjectNo(string projectNo, List<string> itemNumberList)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetConsumptionChildItemStockWithWipQtyByProjectNo API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetConsumptionChildItemStockWithWipQtyByProjectNo API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetConsumptionChildItemStockWithWipQtyByMultipleProjectNo(coverageInventoryByMultipleProjectDto coverageInventoryByMultipleProjectDto)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetConsumptionChildItemStockWithWipQtyByMultipleProjectNo API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetConsumptionChildItemStockWithWipQtyByMultipleProjectNo API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> UpdateInventoryOnShopOrderConfirmation(List<InventoryDtoForShopOrderConfirmation> dtoForShopOrderConfirmation)
        {
            ...
            try
            {
                foreach (var item in dtoForShopOrderConfirmation)
                {
                    ...
                    for (int i = 0; i < inventoryDetails.Count; i++)
                    {
                        ...
                        InventoryTranction inventoryTransaction22 = new InventoryTranction();
                        inventoryTransaction22.PartNumber = inventoryDetails[i].PartNumber;
                        inventoryTransaction22.MftrPartNumber = inventoryDetails[i].MftrPartNumber;
                        inventoryTransaction22.ProjectNumber = inventoryDetails[i].ProjectNumber;
                        inventoryTransaction22.Description = inventoryDetails[i].Description;
                        inventoryTransaction22.Issued_Quantity = lotNoWiseProducedQty;
                        inventoryTransaction22.LotNumber = inventoryDetails[i].LotNumber;
                        inventoryTransaction22.UOM = inventoryDetails[i].UOM;
                        inventoryTransaction22.GrinMaterialType = "";
                        inventoryTransaction22.shopOrderNo = item.ShopOrderNumber;
                        inventoryTransaction22.Unit = _unitname;
                        inventoryTransaction22.GrinNo = inventoryDetails[i].GrinNo;
                        inventoryTransaction22.GrinPartId = inventoryDetails[i].GrinPartId;
                        inventoryTransaction22.IsStockAvailable = false;
                        inventoryTransaction22.Warehouse = inventoryDetails[i].Warehouse;
                        inventoryTransaction22.From_Location = "WIP";
                        inventoryTransaction22.TO_Location = inventoryDetails[i].Location;
                        inventoryTransaction22.PartType = inventoryDetails[i].PartType;
                        inventoryTransaction22.ReferenceID = item.ShopOrderNumber;
                        inventoryTransaction22.ReferenceIDFrom = "ShopOrderConfirmation";
                        inventoryTransaction22.Remarks = "ShopOrderConfirmation";
                        inventoryTransaction22.TransactionType = InventoryType.Outward;
                        await _inventoryTranctionRepository.CreateInventoryTransaction(inventoryTransaction22);
            ...
            {
                _logger.LogError($"Error Occured in UpdateInventoryOnShopOrderConfirmation API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in UpdateInventoryOnShopOrderConfirmation API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> UpdateInventoryOnMaterialIssue(InventoryDtoForMaterialIssue dtoForMaterialIssue)
        {
            ...
            {
                _logger.LogError($"Error Occured in UpdateInventoryOnMaterialIssue API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in UpdateInventoryOnMaterialIssue API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> UpdateInventoryOnMaterialIssueLocation(InventoryDtoForMaterialIssueLocation dtoForMaterialIssue)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < inventoryDetails.Count(); i++)
                {
                    ...
                    if (inventoryDetails[i].Balance_Quantity <= disQty)
                    {
                        ...
                        inventoryTranctionPost1.PartNumber = inventoryDetails[i].PartNumber;
                        inventoryTranctionPost1.MftrPartNumber = inventoryDetails[i].MftrPartNumber;
                        inventoryTranctionPost1.ProjectNumber = inventoryDetails[i].ProjectNumber;
                        inventoryTranctionPost1.Description = inventoryDetails[i].Description;
                        inventoryTranctionPost1.Issued_Quantity = inventoryDetails[i].Balance_Quantity;
                        inventoryTranctionPost1.LotNumber = inventoryDetails[i].LotNumber;
                        inventoryTranctionPost1.UOM = inventoryDetails[i].UOM;
                        inventoryTranctionPost1.GrinMaterialType = "";
                        inventoryTranctionPost1.shopOrderNo = shopOrderNumber;
                        inventoryTranctionPost1.Unit = _unitname;
                        inventoryTranctionPost1.GrinNo = inventoryDetails[i].GrinNo;
                        inventoryTranctionPost1.GrinPartId = inventoryDetails[i].GrinPartId;
                        inventoryTranctionPost1.IsStockAvailable = false;
                        inventoryTranctionPost1.Warehouse = inventoryDetails[i].Warehouse;
                        inventoryTranctionPost1.From_Location = inventoryDetails[i].Location;
                        inventoryTranctionPost1.TO_Location = "WIP";
                        inventoryTranctionPost1.PartType = inventoryDetails[i].PartType;
                        inventoryTranctionPost1.ReferenceID = shopOrderNumber;
                        inventoryTranctionPost1.ReferenceIDFrom = "MaterialIssue";
                        inventoryTranctionPost1.Remarks = "MaterialIssue";
                    ...
                    else
                    {
                        ...
                        inventoryTranctionPost1.ProjectNumber = inventoryDetails[i].ProjectNumber;
                        inventoryTranctionPost1.Description = inventoryDetails[i].Description;
                        inventoryTranctionPost1.Issued_Quantity = disQty;
                        inventoryTranctionPost1.LotNumber = inventoryDetails[i].LotNumber;
                        inventoryTranctionPost1.UOM = inventoryDetails[i].UOM;
                        inventoryTranctionPost1.GrinMaterialType = "";
                        inventoryTranctionPost1.shopOrderNo = shopOrderNumber;
                    ...
                    InventoryTranction inventoryTranction2 = new InventoryTranction();
                    inventoryTranction2.PartNumber = inventoryDetails[i].PartNumber;
                    inventoryTranction2.MftrPartNumber = inventoryDetails[i].MftrPartNumber;
                    inventoryTranction2.ProjectNumber = inventoryDetails[i].ProjectNumber;
                    inventoryTranction2.Description = inventoryDetails[i].Description;
                    inventoryTranction2.Issued_Quantity = inventoryDetails[i].Balance_Quantity;
                    inventoryTranction2.LotNumber = inventoryDetails[i].LotNumber;
                    inventoryTranction2.UOM = inventoryDetails[i].UOM;
                    inventoryTranction2.GrinMaterialType = "";
                    inventoryTranction2.shopOrderNo = shopOrderNumber;
                    inventoryTranction2.Unit = _unitname;
                    inventoryTranction2.GrinNo = inventoryDetails[i].GrinNo;
                    inventoryTranction2.GrinPartId = inventoryDetails[i].GrinPartId;
                    inventoryTranction2.IsStockAvailable = true;
                    inventoryTranction2.Warehouse = "WIP";
                    inventoryTranction2.From_Location = inventoryDetails[i].Location;
                    inventoryTranction2.TO_Location = "WIP";
                    inventoryTranction2.PartType = inventoryDetails[i].PartType;
                    inventoryTranction2.ReferenceID = shopOrderNumber;
                    inventoryTranction2.ReferenceIDFrom = "MaterialIssue";
                    inventoryTranction2.Remarks = "MaterialIssue";
                    inventoryTranction2.TransactionType = InventoryType.Inward;
                    await _inventoryTranctionRepository.CreateInventoryTransaction(inventoryTranction2);
            ...
            {
                _logger.LogError($"Error Occured in UpdateInventoryOnMaterialIssueLocation API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in UpdateInventoryOnMaterialIssueLocation API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetInventoryDetailsWithInventoryStock(string itemNumber, string warehouse, string location, string projectNumber)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetInventoryDetailsWithInventoryStock API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventoryDetailsWithInventoryStock API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> MaterialInventoryBalanceQty([FromBody] List<UpdateInventoryBalanceQty> updateInventoryBalanceQty)
        {
                        ...
                        if (Location.IsMRIssueDone != true)
                        {
                            ...
                            foreach (var invItem in inventories)
                            {
                                ...
                                if (stock <= issuedQty)
                                {
                                    ...
                                    wipInventory = MRInsertWipDetailsInInventoryWhenIssuedQtyIsMore(invItem, lotNoWiseIssuedQty, shopOrderNumber);
                                    ...
                                    inventoryTransaction1.PartNumber = invItem.PartNumber;
                                    inventoryTransaction1.MftrPartNumber = invItem.MftrPartNumber;
                                    inventoryTransaction1.ProjectNumber = invItem.ProjectNumber;
                                    inventoryTransaction1.Description = invItem.Description;
                                    inventoryTransaction1.Issued_Quantity = stock;
                                    inventoryTransaction1.LotNumber = invItem.LotNumber;
                                    inventoryTransaction1.UOM = invItem.UOM;
                                    inventoryTransaction1.GrinMaterialType = "";
                                    inventoryTransaction1.shopOrderNo = shopOrderNumber;
                                    inventoryTransaction1.Unit = _unitname;
                                    inventoryTransaction1.GrinNo = invItem.GrinNo;
                                    inventoryTransaction1.GrinPartId = invItem.GrinPartId;
                                    inventoryTransaction1.IsStockAvailable = false;
                                    inventoryTransaction1.Warehouse = invItem.Warehouse;
                                    inventoryTransaction1.From_Location = invItem.Location;
                                    inventoryTransaction1.TO_Location = "WIP";
                                    inventoryTransaction1.PartType = invItem.PartType;
                                    inventoryTransaction1.ReferenceID = mrNumber;
                                    inventoryTransaction1.ReferenceIDFrom = "Material Request";
                                    inventoryTransaction1.Remarks = "Material Request";
                                    inventoryTransaction1.TransactionType = InventoryType.Outward;
                                    await _inventoryTranctionRepository.CreateInventoryTransaction(inventoryTransaction1);
                                ...
                                else
                                {
                                    ...
                                    wipInventory = MRInsertWipDetailsInInventoryWhenIssuedQtyIsMore(invItem, issuedQty, shopOrderNumber);
                                    wipInventory.ReferenceID = mrNumber;
                                    await _inventoryRepository.CreateInventory(wipInventory);
                                    ...
                                    inventoryTransaction1.ProjectNumber = invItem.ProjectNumber;
                                    inventoryTransaction1.Description = invItem.Description;
                                    inventoryTransaction1.Issued_Quantity = issuedQty;
                                    inventoryTransaction1.LotNumber = invItem.LotNumber;
                                    inventoryTransaction1.UOM = invItem.UOM;
                                    inventoryTransaction1.GrinMaterialType = "";
                                    inventoryTransaction1.shopOrderNo = shopOrderNumber;
                                ...
                                inventoryTransaction.PartNumber = wipInventory.PartNumber;
                                inventoryTransaction.MftrPartNumber = wipInventory.MftrPartNumber;
                                inventoryTransaction.ProjectNumber = wipInventory.ProjectNumber;
                                inventoryTransaction.Description = wipInventory.Description;
                                inventoryTransaction.Issued_Quantity = wipInventory.Balance_Quantity;
                                inventoryTransaction.LotNumber = wipInventory.LotNumber;
                                inventoryTransaction.UOM = wipInventory.UOM;
                                inventoryTransaction.GrinMaterialType = "";
                                inventoryTransaction.shopOrderNo = shopOrderNumber;
                                inventoryTransaction.Unit = _unitname;
                                inventoryTransaction.GrinNo = wipInventory.GrinNo;
                                inventoryTransaction.GrinPartId = wipInventory.GrinPartId;
                                inventoryTransaction.IsStockAvailable = true;
                                inventoryTransaction.Warehouse = wipInventory.Warehouse;
                                inventoryTransaction.From_Location = invItem.Location;
                                inventoryTransaction.TO_Location = "WIP";
                                inventoryTransaction.PartType = wipInventory.PartType;
                                inventoryTransaction.ReferenceID = mrNumber;
                                inventoryTransaction.ReferenceIDFrom = "Material Request";
                                inventoryTransaction.Remarks = "Material Request";
                                inventoryTransaction.TransactionType = InventoryType.Inward;
                                await _inventoryTranctionRepository.CreateInventoryTransaction(inventoryTransaction);
            ...
            {
                _logger.LogError($"Error Occured in MaterialInventoryBalanceQty API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in MaterialInventoryBalanceQty API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> MaterialReturnNoteInventoryBalanceQty([FromBody] List<MRNUpdateInventoryBalanceQty> updateInventoryBalanceQty)
        {
                                    ...
                                    if (inventories != null || inventories.Count() > 0)
                                    {
                                        foreach (var inventoryDetail in inventories)
                                        {
                                            ...
                                            if (wipQtyInventoryQty > wipQtyInIssueTracker)
                                            {
                                                ...
                                                InventoryTranction inventoryTranctionPost1 = new InventoryTranction();
                                                inventoryTranctionPost1.PartNumber = inventoryDetail.PartNumber;
                                                inventoryTranctionPost1.MftrPartNumber = inventoryDetail.MftrPartNumber;
                                                inventoryTranctionPost1.ProjectNumber = inventoryDetail.ProjectNumber;
                                                inventoryTranctionPost1.Description = inventoryDetail.Description;
                                                inventoryTranctionPost1.Issued_Quantity = wipQtyInIssueTracker;
                                                inventoryTranctionPost1.LotNumber = inventoryDetail.LotNumber;
                                                inventoryTranctionPost1.UOM = inventoryDetail.UOM;
                                                inventoryTranctionPost1.GrinMaterialType = "";
                                                inventoryTranctionPost1.shopOrderNo = shopOrderNumber;
                                                inventoryTranctionPost1.Unit = _unitname;
                                                inventoryTranctionPost1.GrinNo = inventoryDetail.GrinNo;
                                                inventoryTranctionPost1.GrinPartId = inventoryDetail.GrinPartId;
                                                inventoryTranctionPost1.IsStockAvailable = false;
                                                inventoryTranctionPost1.Warehouse = inventoryDetail.Warehouse;
                                                inventoryTranctionPost1.From_Location = inventoryDetail.Location;
                                                inventoryTranctionPost1.TO_Location = "WIP";
                                                inventoryTranctionPost1.PartType = inventoryDetail.PartType;
                                                inventoryTranctionPost1.ReferenceID = shopOrderNumber;
                                                inventoryTranctionPost1.ReferenceIDFrom = "Material Return Note";
                                                inventoryTranctionPost1.Remarks = "Material Return Note";
                                                inventoryTranctionPost1.TransactionType = InventoryType.Outward;
                                                await _inventoryTranctionRepository.CreateInventoryTransaction(inventoryTranctionPost1);
                                                ...
                                                InventoryTranction inventoryTransaction2 = new InventoryTranction();
                                                inventoryTransaction2.PartNumber = inventoryPost.PartNumber;
                                                inventoryTransaction2.MftrPartNumber = inventoryPost.MftrPartNumber;
                                                inventoryTransaction2.ProjectNumber = inventoryPost.ProjectNumber;
                                                inventoryTransaction2.Description = inventoryPost.Description;
                                                inventoryTransaction2.Issued_Quantity = inventoryPost.Balance_Quantity;
                                                inventoryTransaction2.LotNumber = inventoryPost.LotNumber;
                                                inventoryTransaction2.UOM = inventoryPost.UOM;
                                                inventoryTransaction2.GrinMaterialType = "";
                                                inventoryTransaction2.shopOrderNo = shopOrderNumber;
                                                inventoryTransaction2.Unit = _unitname;
                                                inventoryTransaction2.GrinNo = inventoryPost.GrinNo;
                                                inventoryTransaction2.GrinPartId = inventoryPost.GrinPartId;
                                                inventoryTransaction2.IsStockAvailable = true;
                                                inventoryTransaction2.Warehouse = "WIP";
                                                inventoryTransaction2.From_Location = inventoryPost.Location;
                                                inventoryTransaction2.TO_Location = "WIP";
                                                inventoryTransaction2.PartType = inventoryPost.PartType;
                                                inventoryTransaction2.ReferenceID = shopOrderNumber;
                                                inventoryTransaction2.ReferenceIDFrom = "Material Return Note";
                                                inventoryTransaction2.Remarks = "Material Return Note";
                                                inventoryTransaction2.TransactionType = InventoryType.Inward;
                                                await _inventoryTranctionRepository.CreateInventoryTransaction(inventoryTransaction2);

                                                wipQtyInIssueTracker = 0;
                                            }
                                            else
                                            {
                                                InventoryTranction inventoryTransaction11 = new InventoryTranction();
                                                inventoryTransaction11.PartNumber = inventoryDetail.PartNumber;
                                                inventoryTransaction11.MftrPartNumber = inventoryDetail.MftrPartNumber;
                                                inventoryTransaction11.ProjectNumber = inventoryDetail.ProjectNumber;
                                                inventoryTransaction11.Description = inventoryDetail.Description;
                                                inventoryTransaction11.Issued_Quantity = inventoryDetail.Balance_Quantity;
                                                inventoryTransaction11.LotNumber = inventoryDetail.LotNumber;
                                                inventoryTransaction11.UOM = inventoryDetail.UOM;
                                                inventoryTransaction11.GrinMaterialType = "";
                                                inventoryTransaction11.shopOrderNo = shopOrderNumber;
                                                inventoryTransaction11.Unit = _unitname;
                                                inventoryTransaction11.GrinNo = inventoryDetail.GrinNo;
                                                inventoryTransaction11.GrinPartId = inventoryDetail.GrinPartId;
                                                inventoryTransaction11.IsStockAvailable = false;
                                                inventoryTransaction11.Warehouse = "WIP";
                                                inventoryTransaction11.From_Location = "WIP";
                                                inventoryTransaction11.TO_Location = Location.Location;
                                                inventoryTransaction11.PartType = inventoryDetail.PartType;
                                                inventoryTransaction11.ReferenceID = shopOrderNumber;
                                                inventoryTransaction11.ReferenceIDFrom = "Material Return Note";
                                                inventoryTransaction11.Remarks = "Material Return Note";
                                                inventoryTransaction11.TransactionType = InventoryType.Outward;
                                                await _inventoryTranctionRepository.CreateInventoryTransaction(inventoryTransaction11);
                                                ...
                                                InventoryTranction inventoryTransaction22 = new InventoryTranction();
                                                inventoryTransaction22.PartNumber = inventoryDetail.PartNumber;
                                                inventoryTransaction22.MftrPartNumber = inventoryDetail.MftrPartNumber;
                                                inventoryTransaction22.ProjectNumber = inventoryDetail.ProjectNumber;
                                                inventoryTransaction22.Description = inventoryDetail.Description;
                                                inventoryTransaction22.Issued_Quantity = inventoryDetail.Balance_Quantity;
                                                inventoryTransaction22.LotNumber = inventoryDetail.LotNumber;
                                                inventoryTransaction22.UOM = inventoryDetail.UOM;
                                                inventoryTransaction22.GrinMaterialType = "";
                                                inventoryTransaction22.shopOrderNo = shopOrderNumber;
                                                inventoryTransaction22.Unit = _unitname;
                                                inventoryTransaction22.GrinNo = inventoryDetail.GrinNo;
                                                inventoryTransaction22.GrinPartId = inventoryDetail.GrinPartId;
                                                inventoryTransaction22.IsStockAvailable = true;
                                                inventoryTransaction22.Warehouse = inventoryDetail.Warehouse;
                                                inventoryTransaction22.From_Location = "WIP";
                                                inventoryTransaction22.TO_Location = inventoryDetail.Location;
                                                inventoryTransaction22.PartType = inventoryDetail.PartType;
                                                inventoryTransaction22.ReferenceID = shopOrderNumber;
                                                inventoryTransaction22.ReferenceIDFrom = "Material Return Note";
                                                inventoryTransaction22.Remarks = "Material Return Note";
                                                inventoryTransaction22.TransactionType = InventoryType.Inward;
                                                await _inventoryTranctionRepository.CreateInventoryTransaction(inventoryTransaction22);
            ...
            {
                _logger.LogError($"Error Occured in MaterialReturnNoteInventoryBalanceQty API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in MaterialReturnNoteInventoryBalanceQty API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetInventoryById(int id)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetInventoryById API for the following id:{id} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventoryById API for the following id:{id} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> SearchInventoryDate([FromQuery] SearchsDateParms searchDateParam)
        {
            ...
            {
                _logger.LogError($"Error Occured in SearchInventoryDate API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in SearchInventoryDate API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> SearchInventory([FromQuery] SearchParames searchParames)
        {
            ...
            {
                _logger.LogError($"Error Occured in SearchInventory API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in SearchInventory API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> SearchInventoryDetailsWithSumOfStock([FromQuery] InventoryItemNo inventoryItemNo)
        {
            ...
            {
                _logger.LogError($"Error Occured in SearchInventoryDetailsWithSumOfStock API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in SearchInventoryDetailsWithSumOfStock API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetAllInventoryWithItems([FromBody] InventorySearchDto inventorySearch)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetAllInventoryWithItems API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetAllInventoryWithItems API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetInventoryDetailsWithSumOfStock([FromBody] InventoryBalQty inventoryBalQty)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetInventoryDetailsWithSumOfStock API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventoryDetailsWithSumOfStock API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetInventoryDetailsWithSumOfBalQty([FromBody] InventoryDetailsBalQty inventoryDetailsBalQty)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetInventoryDetailsWithSumOfBalQty API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventoryDetailsWithSumOfBalQty API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetRandomInventoryItemDetails()
        {
            ...
            {
                _logger.LogError($"Error Occured in GetRandomInventoryItemDetails API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetRandomInventoryItemDetails API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> CreateInventory([FromBody] InventoryDtoPost inventoryDtoPost)
        {
            ...
            {
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in CreateInventory API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.BadRequest;
                _logger.LogError($"Error Occured in CreateInventory API : \n {ex.Message} \n{ex.InnerException}");
                return StatusCode(500, serviceResponse);
            }
        }
        ...
        public async Task<IActionResult> CreateInventoryForOqcBinning([FromBody] InventoryOqcBinningPostDto inventoryDtoPost)
        {
            ...
            {
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in CreateInventoryForOqcBinning API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.BadRequest;
                _logger.LogError($"Error Occured in CreateInventoryForOqcBinning API : \n {ex.Message} \n{ex.InnerException}");
                return StatusCode(500, serviceResponse);
            }
        }
        ...
        public async Task<IActionResult> CreateInventoryFromGrin([FromBody] InventoryGrinDtoPost inventoryDto)
        {
            ...
            {
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in CreateInventoryFromGrin API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.BadRequest;
                _logger.LogError($"Error Occured in CreateInventoryFromGrin API : \n {ex.Message} \n{ex.InnerException}");
                return StatusCode(500, serviceResponse);
            }
        }
        ...
        public async Task<IActionResult> UpdateInventory(int id, [FromBody] InventoryDtoUpdate inventoryDtoUpdate)
        {
            ...
            {
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in UpdateInventory API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.BadRequest;
                _logger.LogError($"Error Occured in UpdateInventory API : \n {ex.Message} \n{ex.InnerException}");
                return StatusCode(500, serviceResponse);
            }
        }
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteInventory(int id)
        {
            ...
            {
                _logger.LogError($"Error Occured in DeleteInventory API for the following id:{id} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in DeleteInventory API for the following id:{id} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<ActionResult<decimal>> GetTotalStockOfItemNumber(string saItemNumber)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetTotalStockOfItemNumber API for the following saItemNumber:{saItemNumber} \n {ex.Message} \n{ex.InnerException}");
                inventoryServiceResponse.Success = false;
                inventoryServiceResponse.Message = $"Error Occured in GetTotalStockOfItemNumber API for the following saItemNumber:{saItemNumber} \n {ex.Message}";
        ...
        public async Task<ActionResult<decimal>> GetTotalStockOfSAItemNumberAndProjectNo(string saItemNumber, string projectNumber)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetTotalStockOfSAItemNumberAndProjectNo API for the following saItemNumber:{saItemNumber} and projectNumber:{projectNumber} \n {ex.Message} \n{ex.InnerException}");
                inventoryServiceResponse.Success = false;
                inventoryServiceResponse.Message = $"Error Occured in GetTotalStockOfSAItemNumberAndProjectNo API for the following saItemNumber:{saItemNumber} and projectNumber:{projectNumber} \n {ex.Message}";
                return StatusCode(500, inventoryServiceResponse);
            }
        }
        ...
        public async Task<IActionResult> GetCrossMarginSPReportsWithParam([FromBody] CrossMarginSPReportDto crossMarginSPReportDto)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetCrossMarginSPReportsWithParam API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetCrossMarginSPReportsWithParam API : \n {ex.Message} ";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetStockMovementSPReports()
        {
            ...
            {
                _logger.LogError($"Error Occured in GetStockMovementSPReports API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetStockMovementSPReports API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetStockMovementLatestSPReports()
        {
            ...
            {
                _logger.LogError($"Error Occured in GetStockMovementLatestSPReports API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetStockMovementLatestSPReports API : \n {ex.Message} ";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetStockMovementHistorySPReportsWithDate(StockMovementHistorySPReportDto stockMovementHistorySPReportDto)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetStockMovementHistorySPReportsWithDate API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetStockMovementHistorySPReportsWithDate API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetTrascationKPNWSPReportsWithParam([FromBody] TrascationKPNWSPReportsDto trascationKPNWSPReportsDto)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetTrascationKPNWSPReportsWithParam API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetTrascationKPNWSPReportsWithParam API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetInventoryBySumOfFilteringDatesSPReportsWithParam([FromBody] InventoryBySumOfFilteringDatesSPReportDto inventoryBySumOfFilteringDatesSPReportDto)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetInventoryBySumOfFilteringDatesSPReportsWithParam API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventoryBySumOfFilteringDatesSPReportsWithParam API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetWareproInventoryWithLocationTranferSPReportsWithParam([FromBody] InventorySPReportDto inventorySPReportDto)
        {
            ...
            try
            {
                var products = await _inventoryRepository.GetWareproInventoryWithLocationTranferSPReportsWithParam(inventorySPReportDto.PartNumber, inventorySPReportDto.Description,
                ...
                {
                    serviceResponse.Data = null;
                    serviceResponse.Message = $"WareproInventorySPReportsWithParam hasn't been found.";
                    serviceResponse.Success = false;
                    serviceResponse.StatusCode = HttpStatusCode.OK;
                    _logger.LogError($"WareproInventorySPReportsWithParam hasn't been found in db.");
                    return Ok(serviceResponse);
                }
                else
                {
                    serviceResponse.Data = products;
                    serviceResponse.Message = "Returned WareproInventorySPReportsWithParam Details";
                    serviceResponse.Success = true;
                    serviceResponse.StatusCode = HttpStatusCode.OK;
                    return Ok(serviceResponse);
                }
            ...
            {
                _logger.LogError($"Error Occured in GetWareproInventoryWithLocationTranferSPReportsWithParam API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetWareproInventoryWithLocationTranferSPReportsWithParam API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        [HttpPost] 
        public async Task<IActionResult> GetWIPInventorySPReportsWithParam([FromBody] InventoryWIPSPReportDto inventoryWIPSPReportDto)
        {
            ServiceResponse<IEnumerable<InventoryWIPSPReport>> serviceResponse = new ServiceResponse<IEnumerable<InventoryWIPSPReport>>();
            try
            {
                var products = await _inventoryRepository.GetWIPInventorySPReportsWithParam(inventoryWIPSPReportDto.PartNumber, inventoryWIPSPReportDto.Warehouse,
                                                                                inventoryWIPSPReportDto.Location, inventoryWIPSPReportDto.ProjectNumber);

                if (products == null)
                {
                    serviceResponse.Data = null;
                    serviceResponse.Message = $"InventoryWIPSPReportsWithParam hasn't been found.";
                    serviceResponse.Success = false;
                    serviceResponse.StatusCode = HttpStatusCode.OK;
                    _logger.LogError($"InventoryWIPSPReportsWithParam hasn't been found in db.");
                    return Ok(serviceResponse);
                }
                else
                {
                    serviceResponse.Data = products;
                    serviceResponse.Message = "Returned InventoryWIPSPReportsWithParam Details";
                    serviceResponse.Success = true;
                    serviceResponse.StatusCode = HttpStatusCode.OK;
                    return Ok(serviceResponse);
                }
            ...
            {
                _logger.LogError($"Error Occured in GetWIPInventorySPReportsWithParam API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetWIPInventorySPReportsWithParam API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetInventorySPReportsWithParam([FromBody] InventorySPReportDto inventorySPReportDto)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetInventorySPReportsWithParam API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventorySPReportsWithParam API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> InventorySumSPReportWithdate([FromBody] GetInventorySPReportForAviDto inventorySPReportForAviDto)
        {
            ...
            {
                _logger.LogError($"Error Occured in InventorySumSPReportWithdate API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in InventorySumSPReportWithdate API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetInventoryDashboardSPReportsWithParam()
        {
            ...
            {
                _logger.LogError($"Error Occured in GetInventoryDashboardSPReportsWithParam API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventoryDashboardSPReportsWithParam API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetInventoryDashboardLastWeekSPReportsWithParam()
        {
            ...
            {
                _logger.LogError($"Error Occured in GetInventoryDashboardLastWeekSPReportsWithParam API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventoryDashboardLastWeekSPReportsWithParam API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetInventorySPReportForAvision([FromBody] GetInventorySPReportForAviDto getInventorySPReportForAviDto)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetInventorySPReportForAvision API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventorySPReportForAvision API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetInventoryForStockSPReportsWithParam([FromBody] InventoryForStockSPReportDto inventoryForStockSPReportDto)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetInventoryForStockSPReportsWithParam API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventoryForStockSPReportsWithParam API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetInventoryWarehouseReport([FromBody] InventorySPReportDto inventoryWarehouseReportDto)
        {
            ...
            catch (Exception ex)
            {
                ...
                _logger.LogError($"Error Occured in GetInventoryWarehouseReport API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventoryWarehouseReport API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetInventoryWIPReport([FromBody] InventorySPReportDto inventoryWarehouseReportDto)
        {
            ...
            catch (Exception ex)
            {
                ...
                _logger.LogError($"Error Occured in GetInventoryWIPReport API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventoryWIPReport API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetInventoryWIPExcelReport([FromBody] InventorySPReportDto inventoryWarehouseReportDto)
        {
            ...
            {
                _logger.LogError($"Error occured in GetInventoryWIPExcelReport API:{ex.Message} \n {ex.InnerException}");
        ...
        public async Task<IActionResult> GetInventoryGrinAndIqcReport([FromBody] InventorySPReportDto inventoryWarehouseReportDto)
        {
            ...
            catch (Exception ex)
            {
                ...
                _logger.LogError($"Error Occured in GetInventoryGrinAndIqcReport API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventoryGrinAndIqcReport API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetInventoryOpenGrinForGrinAndOpenGrinForIQCReport([FromBody] InventorySPReportDto inventoryWarehouseReportDto)
        {
            ...
            catch (Exception ex)
            {
                ...
                _logger.LogError($"Error Occured in GetInventoryOpenGrinForGrinAndOpenGrinForIQCReport API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventoryOpenGrinForGrinAndOpenGrinForIQCReport API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetInventoryNotUseableReport([FromBody] InventorySPReportDto inventoryWarehouseReportDto)
        {
            ...
            catch (Exception ex)
            {
                ...
                _logger.LogError($"Error Occured in GetInventoryNotUseableReport API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetInventoryNotUseableReport API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
