...
namespace Tips.Warehouse.Api.Contracts
{
    public interface IReturnBtoDeliveryOrderRepository : IRepositoryBase<ReturnBtoDeliveryOrder>
    {
        ...
        Task<IEnumerable<ReturnDOSPReport>> ReturnDOSPReportWithParam(string? CustomerName, string? CustomerAliasName, string? CustomerLeadId, string? SalesOrderNumber, string? ProductType, string? TypeOfSolution, string? Warehouse, string? Location, string? KPN, string? MPN);
    }
}
