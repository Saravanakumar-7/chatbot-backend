...
{   
    public interface IOpenDeliveryOrderRepository : IRepositoryBase<OpenDeliveryOrder>
    {
        ...
        Task<IEnumerable<OpenDeliveryOrderSPReport>> OpenDeliveryOrderSPReportWithParamForTrans(string OpenDONumber, string CustomerName, string CustomerAliasName, string LeadId,
