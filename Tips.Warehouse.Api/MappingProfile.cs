...
namespace Tips.Warehouse.Api
{
    public class MappingProfile : Profile
    {
        ...
        {
            CreateMap<InventoryForServiceItems, InventoryForServiceItemsGrinDtoPost>().ReverseMap();
            CreateMap<InventoryForServiceItems, InventoryForServiceItemsDto>().ReverseMap();
            CreateMap<InventoryForServiceItems, InventoryForServiceItemsDtoUpdate>().ReverseMap();
            ...
            CreateMap<Inventory, InventoryOqcBinningPostDto>().ReverseMap();
            ...
            CreateMap<ReturnInvoiceAdditionalCharge, ReturnInvoiceAdditionalChargesDto>().ReverseMap();
            CreateMap<ReturnInvoiceAdditionalCharge, ReturnInvoiceAdditionalChargesPostDto>().ReverseMap();
            CreateMap<ReturnInvoiceAdditionalCharge, ReturnInvoiceAdditionalChargesUpdateDto>().ReverseMap();
