...
namespace Entities.DTOs
{
    public class LeadDto
    {
        ...
        public List<LeadAddressDto>? LeadAddresses { get; set; }


    }
    public class LeadDtoPost
    {
        [StringLength(100, ErrorMessage = "ContactName can't be longer than 100 characters")]

        public string? ContactName { get; set; }
        [StringLength(100, ErrorMessage = "CustomerFirstName can't be longer than 100 characters")]
        public string? CustomerFirstName { get; set; }
        [StringLength(100, ErrorMessage = "CustomerLastName can't be longer than 100 characters")]
        public string? CustomerLastName { get; set; }
    ...
    public string? Tags { get; set; }
        public string Unit { get; set; }
        public List<LeadAddressUpdateDto>? LeadAddresses { get; set; }
