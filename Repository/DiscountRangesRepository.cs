...
namespace Repository
{
    internal class DiscountRangesRepository : RepositoryBase<DiscountRanges>, IDiscountRangesRepository
    {
        ...
        {
            var query = FindAll().Include(x => x.DiscountUsers).OrderByDescending(x => x.Id);
        ...
        public async Task<PagedList<DiscountRanges>> GetAllActiveDiscount(PagingParameter pagingParameter)
        {
