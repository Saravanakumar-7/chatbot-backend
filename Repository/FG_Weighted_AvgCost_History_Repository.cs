...
{
    public class FG_Weighted_AvgCost_History_Repository : RepositoryBase<FG_Weighted_AvgCost_History>, I_FG_Weighted_AvgCost_History_Repository
    {
        ...
        {
            foreach (var FG in fG_Weighted_AvgCost_Histories)
            {
                FG.Id = 0;
                await Create(FG);
            }
