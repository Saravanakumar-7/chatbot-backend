...
namespace Tips.Grin.Api.Controllers
{
    ...
    public class OpenGrinForIQCController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllOpenGrinForIQCDetails([FromQuery] PagingParameter pagingParameter, [FromQuery] SearchParams searchParams)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetAllOpenGrinForIQCDetails API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetAllOpenGrinForIQCDetails API : \n {ex.Message}";
        ...
        public async Task<IActionResult> GetOpenGrinForIQCSPReportWithParam([FromBody] OpenGrinForIQCSPReportWithParamDto openGrinForIQCSPReportWithParamDto)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetOpenGrinForIQCSPReportWithParam API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetOpenGrinForIQCSPReportWithParam API : \n {ex.Message} ";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
        ...
        public async Task<IActionResult> GetOpenGrinForIQCSPReportWithParamForTrans([FromBody] OpenGrinForIQCSPReportWithParamForTransDto openGrinForIQCSPReportWithParamDto)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetOpenGrinForIQCSPReportWithParamForTrans API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetOpenGrinForIQCSPReportWithParamForTrans API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetOpenGrinForIQCSPReportWithDate([FromQuery] DateTime? FromDate, [FromQuery] DateTime? ToDate)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetOpenGrinForIQCSPReportWithDate API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetOpenGrinForIQCSPReportWithDate API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetOpenGrinForIQCDetailsbyId(int id)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetOpenGrinForIQCDetailsbyId API for the following id:{id} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetOpenGrinForIQCDetailsbyId API for the following id:{id} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, "Internal server error");
            }
        ...
        public async Task<IActionResult> CreateOpenGrinForIQC([FromBody] OpenGrinForIQCPostDto openGrinForIQCPostDto)
        {
                    ...
                    for (int i = 0; i < openGrinForIQCItemsDto.Count; i++)
                    {
                        ...
                        foreach (var projectNo in openGrinForGrinItemDetails.OGNProjectNumber)
                        {
                            ...
                            if (inventoryObject != null)
                            {
                                ...
                                iqcInventoryTranctionDto.Remarks = "OPGIQC Done";
                                ...
                                if (openGrinForIQCItemsDto[i].RejectedQty != 0 && acceptedQty == 0 && (flag1 == 1 || flag2 == 1))
                                {
                                    ...
                                    iqcInventoryTranctionDtos.Remarks = "OPGIQC Done";
                    ...
                    for (int i = 0; i < openGrinForIQCItemsDto.Count; i++)
                    {
                        ...
                        foreach (var projectNo in openGrinForGrinItemDetails.OGNProjectNumber)
                        {
                            ...
                            if (inventoryObject != null)
                            {
                                ...
                                iqcInventoryTranctionDto.GrinMaterialType = "OPGGRIN";
                                iqcInventoryTranctionDto.ShopOrderNo = "";
                                iqcInventoryTranctionDto.Remarks = "OpenGrinForIqc Done";
                                ...
                                if (openGrinForIQCItemsDto[i].RejectedQty != 0 && acceptedQty == 0 && (flag1 == 1 || flag2 == 1))
                                {
                                    ...
                                    iqcInventoryTranctionDtos.GrinMaterialType = "OPGGRIN";
                                    iqcInventoryTranctionDtos.ShopOrderNo = "";
                                    iqcInventoryTranctionDtos.Remarks = "OpenGrinForIqc Done";
            ...
            {
                _logger.LogError($"Error Occured in CreateOpenGrinForIQC API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in CreateOpenGrinForIQC API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
                ...
                if (existingOpenGrinForIQCDetails != null)
                {
                    ...
                    foreach (var projectNo in openGrinForGrinItemsDetails.OGNProjectNumber)
                    {
                        ...
                        if (inventoryObject != null)
                        {
                            ...
                            iqcInventoryTranctionDto.GrinMaterialType = "OPGGRIN";
                            iqcInventoryTranctionDto.ShopOrderNo = "";
                            iqcInventoryTranctionDto.Remarks = "OpenGrinForIqcItem Done";
                    ...
                    foreach (var projectNo in openGrinForGrinItemsDetails.OGNProjectNumber)
                    {
                        ...
                        if (inventoryObject != null)
                        {
                            ...
                            if (openGrinForIQCItemsDto.RejectedQty != 0 && acceptedQty == 0 && (flag1 == 1 || flag2 == 1))
                            {
                                ...
                                iqcInventoryTranctionDtos.GrinMaterialType = "OPGGRIN";
                                iqcInventoryTranctionDtos.ShopOrderNo = "";
                                iqcInventoryTranctionDtos.Remarks = "OpenGrinForIqcItem Done";
