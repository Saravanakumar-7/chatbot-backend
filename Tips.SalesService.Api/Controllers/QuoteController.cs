       ...
       // private IGoogleGCPstorageService _googlegcpservice;
        ...
        public async Task<IActionResult> ExportQuotationWithDateSPReportToExcel([FromQuery] DateTime? FromDate, [FromQuery] DateTime? ToDate)
        {
            try
            {
                ...
                foreach (var item in quotationSPReportDetails)
                {
                    ...
                    row.CreateCell(9).SetCellValue(item.QuoteCreatedOn.HasValue ? item.QuoteCreatedOn.Value.ToString("MM-dd-yyyy HH:mm:ss") : "");
                    row.CreateCell(10).SetCellValue(item.QuoteSentOn.HasValue ? item.QuoteSentOn.Value.ToString("MM-dd-yyyy HH:mm:ss") : "");
        ...
        public async Task<IActionResult> ExportSoSummaryQuotationSPReportToExcel([FromBody] SoSummaryQuotePostDto quoteSPReportDto)
        {
            try
            {
                ...
                headerRow.CreateCell(11).SetCellValue("First Quote Email Sent On");
                headerRow.CreateCell(12).SetCellValue("First Quote Sent General Discount");
                headerRow.CreateCell(13).SetCellValue("First Quote Sent General Discount Type");
                headerRow.CreateCell(14).SetCellValue("First Quote Sent Taxed Value");
                headerRow.CreateCell(15).SetCellValue("First Quote Sent Untaxed Value");
                ...
                foreach (var item in soSummaryQuotationDtos)
                {
                    ...
                    row.CreateCell(6).SetCellValue(item.FirstQuoteCreatedOn?.ToString("MM-dd-yyyy HH:mm:ss") ?? "");
                    ...
                    row.CreateCell(10).SetCellValue(item.FirstQuoteSentCreatedOn?.ToString("MM-dd-yyyy HH:mm:ss") ?? "");
                    row.CreateCell(11).SetCellValue(item.FirstQuoteEmailSentOn?.ToString("MM-dd-yyyy HH:mm:ss") ?? "");
                    row.CreateCell(12).SetCellValue((double?)item.FirstQuoteSentGeneralDiscount ?? 0);
                    row.CreateCell(13).SetCellValue(item.FirstQuoteSentGeneralDiscountType ?? "");
                    row.CreateCell(14).SetCellValue((double?)item.FirstQuoteSentTaxedValue ?? 0);
                    row.CreateCell(15).SetCellValue((double?)item.FirstQuoteSentUntaxedValue ?? 0);
                    ...
                    row.CreateCell(18).SetCellValue(item.LatestQuoteSentCreatedOn?.ToString("MM-dd-yyyy HH:mm:ss") ?? "");
                    ...
                    row.CreateCell(25).SetCellValue(item.FirstSOSentCreatedOn?.ToString("MM-dd-yyyy HH:mm:ss") ?? "");
                    ...
                    row.CreateCell(32).SetCellValue(item.LatestSOSentCreatedOn?.ToString("MM-dd-yyyy HH:mm:ss") ?? "");
