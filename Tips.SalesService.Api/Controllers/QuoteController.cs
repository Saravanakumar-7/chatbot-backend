       ...
       // private IGoogleGCPstorageService _googlegcpservice;
        ...
        public async Task<IActionResult> ExportSoSummaryQuotationSPReportToExcel([FromBody] SoSummaryQuotePostDto quoteSPReportDto)
        {
            try
            {
                ...
                headerRow.CreateCell(7).SetCellValue("First Quote Number");
                headerRow.CreateCell(8).SetCellValue("First Quote Revision Number");
                headerRow.CreateCell(9).SetCellValue("First Quote Created On");
                headerRow.CreateCell(10).SetCellValue("First Quote Total Final Amount");
                headerRow.CreateCell(11).SetCellValue("First Quote Sent Number");
                headerRow.CreateCell(12).SetCellValue("First Quote Sent Revision Number");
                headerRow.CreateCell(13).SetCellValue("First Quote Sent Created On");
                headerRow.CreateCell(14).SetCellValue("First Quote Email Sent On");
                headerRow.CreateCell(15).SetCellValue("First Quote Sent General Discount");
                headerRow.CreateCell(16).SetCellValue("First Quote Sent General Discount Type");
                headerRow.CreateCell(17).SetCellValue("First Quote Sent Taxed Value");
                headerRow.CreateCell(18).SetCellValue("First Quote Sent Untaxed Value");
                headerRow.CreateCell(19).SetCellValue("Latest Quote Sent Number");
                headerRow.CreateCell(20).SetCellValue("Latest Quote Sent Revision Number");
                headerRow.CreateCell(21).SetCellValue("Latest Quote Sent Created On");
                headerRow.CreateCell(22).SetCellValue("Latest Quote Sent General Discount");
                headerRow.CreateCell(23).SetCellValue("Latest Quote Sent General Discount Type");
                headerRow.CreateCell(24).SetCellValue("Latest Quote Sent Taxed Value");
                headerRow.CreateCell(25).SetCellValue("Latest Quote Sent Untaxed Value");
                headerRow.CreateCell(26).SetCellValue("First Sales Order Sent Number");
                headerRow.CreateCell(27).SetCellValue("First SO Sent Revision Number");
                headerRow.CreateCell(28).SetCellValue("First SO Sent Created On");
                headerRow.CreateCell(29).SetCellValue("First SO Sent Discount");
                headerRow.CreateCell(30).SetCellValue("First SO Sent Discount Type");
                headerRow.CreateCell(31).SetCellValue("First SO Sent Taxed Value");
                headerRow.CreateCell(32).SetCellValue("First SO Sent Untaxed Value");
                headerRow.CreateCell(33).SetCellValue("Latest Sales Order Sent Number");
                headerRow.CreateCell(34).SetCellValue("Latest SO Sent Revision Number");
                headerRow.CreateCell(35).SetCellValue("Latest SO Sent Created On");
                headerRow.CreateCell(36).SetCellValue("Latest SO Sent Discount");
                headerRow.CreateCell(37).SetCellValue("Latest SO Sent Discount Type");
                headerRow.CreateCell(38).SetCellValue("Latest SO Sent Taxed Value");
                headerRow.CreateCell(39).SetCellValue("Latest SO Sent Untaxed Value");
                ...
                foreach (var item in soSummaryQuotationDtos)
                {
                    ...
                    row.CreateCell(7).SetCellValue(item.FirstQuoteNumber ?? "");
                    row.CreateCell(8).SetCellValue((double?)item.FirstQuoteRevisionNumber ?? 0);
                    row.CreateCell(9).SetCellValue(item.FirstQuoteCreatedOn?.ToString("MM-dd-yyyy HH:mm:ss") ?? "");
                    row.CreateCell(10).SetCellValue((double?)item.FirstQuoteTotalFinalAmount ?? 0);
                    row.CreateCell(11).SetCellValue(item.FirstQuoteSentNumber ?? "");
                    row.CreateCell(12).SetCellValue((double?)item.FirstQuoteSentRevisionNumber ?? 0);
                    row.CreateCell(13).SetCellValue(item.FirstQuoteSentCreatedOn?.ToString("MM-dd-yyyy HH:mm:ss") ?? "");
                    row.CreateCell(14).SetCellValue(item.FirstQuoteEmailSentOn?.ToString("MM-dd-yyyy HH:mm:ss") ?? "");
                    row.CreateCell(15).SetCellValue((double?)item.FirstQuoteSentGeneralDiscount ?? 0);
                    row.CreateCell(16).SetCellValue(item.FirstQuoteSentGeneralDiscountType ?? "");
                    row.CreateCell(17).SetCellValue((double?)item.FirstQuoteSentTaxedValue ?? 0);
                    row.CreateCell(18).SetCellValue((double?)item.FirstQuoteSentUntaxedValue ?? 0);
                    row.CreateCell(19).SetCellValue(item.LatestQuoteSentNumber ?? "");
                    row.CreateCell(20).SetCellValue((double?)item.LatestQuoteSentRevisionNumber ?? 0);
                    row.CreateCell(21).SetCellValue(item.LatestQuoteSentCreatedOn?.ToString("MM-dd-yyyy HH:mm:ss") ?? "");
                    row.CreateCell(22).SetCellValue((double?)item.LatestQuoteSentGeneralDiscount ?? 0);
                    row.CreateCell(23).SetCellValue(item.LatestQuoteSentGeneralDiscountType ?? "");
                    row.CreateCell(24).SetCellValue((double?)item.LatestQuoteSentTaxedValue ?? 0);
                    row.CreateCell(25).SetCellValue((double?)item.LatestQuoteSentUntaxedValue ?? 0);
                    row.CreateCell(26).SetCellValue(item.FirstSalesOrderSentNumber ?? "");
                    row.CreateCell(27).SetCellValue((double?)item.FirstSOSentRevisionNumber ?? 0);
                    row.CreateCell(28).SetCellValue(item.FirstSOSentCreatedOn?.ToString("MM-dd-yyyy HH:mm:ss") ?? "");
                    row.CreateCell(29).SetCellValue((double?)item.FirstSOSentDiscount ?? 0);
                    row.CreateCell(30).SetCellValue(item.FirstSOSentDiscountType ?? "");
                    row.CreateCell(31).SetCellValue((double?)item.FirstSOSentTaxedValue ?? 0);
                    row.CreateCell(32).SetCellValue((double?)item.FirstSOSentUntaxedValue ?? 0);
                    row.CreateCell(33).SetCellValue(item.LatestSalesOrderSentNumber ?? "");
                    row.CreateCell(34).SetCellValue((double?)item.LatestSOSentRevisionNumber ?? 0);
                    row.CreateCell(35).SetCellValue(item.LatestSOSentCreatedOn?.ToString("MM-dd-yyyy HH:mm:ss") ?? "");
                    row.CreateCell(36).SetCellValue((double?)item.LatestSOSentDiscount ?? 0);
                    row.CreateCell(37).SetCellValue(item.LatestSOSentDiscountType ?? "");
                    row.CreateCell(38).SetCellValue((double?)item.LatestSOSentTaxedValue ?? 0);
                    row.CreateCell(39).SetCellValue((double?)item.LatestSOSentUntaxedValue ?? 0);
