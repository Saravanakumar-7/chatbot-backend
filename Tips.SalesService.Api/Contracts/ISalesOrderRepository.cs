...
namespace Tips.SalesService.Api.Contracts
{
    public interface ISalesOrderRepository : IRepositoryBase<SalesOrder>
    {
        ...
        Task<IEnumerable<AdvanceRecievableSPReportDto>> GetAllAdvanceRecievableSPReport(string CustomerId);
        Task<IEnumerable<InitialAdvanceCustomerSPReport>> GetInitialAdvanceCollectionTrackerForCustomerIdSPReport(string CustomerId);
        ...
        Task<IEnumerable<SalesOrderSoStatusSPReportForTrans>> GetSalesOrderSOStatusSPReportWithParamForTrans(string ProjectNumber, string CustomerName, string SalesOrderNumber, string SOStatus, string KPN);
        ...
        Task<IEnumerable<SalesOrderSPReportForTrans>> GetSalesOrderSPReportWithDateForTrans(DateTime? FromDate, DateTime? ToDate);
        ...
        Task<IEnumerable<FQToFSSPReport>> GetFQToFSSPReportWithParam(string FirstQuoteSentNumber, string SOLatestSalesOrderSentNumber, string LeadId, string TypeOfSolution);
        Task<IEnumerable<FQToFSFirstSOSPReport>> GetFQToFSFirstSOSPReportWithParam(string LeadId);
        Task<IEnumerable<FQToFSLatestSOSPReport>> GetFQToFSLatestSOSPReportWithParam(string LeadId);
        Task<IEnumerable<FQToFSFirstQuoteSPReport>> GetFQToFSFirstQuoteSPReportWithParam(string LeadId);
        ...
        Task<IEnumerable<LPCostingforFGSPReport>> GetLPLPCostingforFGSPreport(string projectnumber);
