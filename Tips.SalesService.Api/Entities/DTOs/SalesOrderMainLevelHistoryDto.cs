...
{
    public class SalesOrderMainLevelHistoryDto
    {
        ...
        public List<SalesOrderItemLevelHistoryDto>? SalesOrderItemLevelHistory { get; set; }
        public List<SOAdditionalChargesHistoryDto>? SOAdditionalChargesHistory { get; set; }
    }
    public class SalesOrderMainLevelHistorySP
    {
        public int Id { get; set; }
        public string? LeadId { get; set; }
        public int SalesOrderId { get; set; }
        ...
        public string? LastModifiedBy { get; set; }
        public DateTime? LastModifiedOn { get; set; }
        public string? SalesOrderItemLevelHistories { get; set; }
        public string? SOAdditionalChargesHistories { get; set; }
    }
}
