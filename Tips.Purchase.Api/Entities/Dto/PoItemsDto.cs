...
namespace Tips.Purchase.Api.Entities.Dto
{
    ...
    public class PoItemsApprovalUpdateDto
    {
        ...
        public decimal? KitRevisionNo { get; set; }
        public string? Description { get; set; }
        public string? PONumber { get; set; }                 // Added
        public string? UOM { get; set; }
        public PoPartType? PartType { get; set; }
        public decimal? Allowance { get; set; }
        ...
        public decimal BalanceQty { get; set; }               // Added
        public decimal ReceivedQty { get; set; }              // Added
        public decimal? ShortClosedQty { get; set; }          // Added
        ...
        public bool NowShortClosed { get; set; }              // Kept (extra field)
