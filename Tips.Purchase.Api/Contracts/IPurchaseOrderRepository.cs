...
namespace Tips.Purchase.Api.Contracts
{
    public interface IPurchaseOrderRepository : IRepositoryBase<PurchaseOrder>
    {
        ...
        Task<List<PurchaseOrderDashboardSPReport>> GetPurchaseOrderDashboardSPReportWithParam(string Bucket_Id);
        ...
        Task<string> UpdateApprovalPurchaseOrderWithReplacement(PurchaseOrder purchaseOrder);
        Task<string> DeletePurchaseOrder(PurchaseOrder purchaseOrder);
        Task<List<PONameList>> GetAllActivePurchaseOrderNameList();
        ...
        Task<IEnumerable<PurchaseOrderIdNameListDto>> GetAllKIT_PoNumberListByVendorIdForAvision(string vendorId);
        Task<decimal> GetOpenPoQuantityByItemNumber(string itemNumber);
        Task<string> GeneratePONumberForAvision();
        Task <IEnumerable<PurchaseOrderUnitListSPReportWithParamForTrans>> GetPurchaseOrderUnitListSPReportWithParamForTrans(string itemNumber);
        ...
        Task<IEnumerable<poconfirmation_report_with_pagination_Dto>> GetPoConfirmationSPReportwithDate(DateTime? FromDate, DateTime? ToDate, string? Approval, string? RecordType);
        ...
        Task<IEnumerable<podeliveryschedule_report_with_parameters_with_pagination_Dto>> GetPoDeliveryScheduleSPReportwithDate(DateTime? FromDate, DateTime? ToDate, string? Approval, string? RecordType);
        ...
        Task<IEnumerable<podeliveryschedule_report_with_parameters_with_pagination_Dto>> GetPoDeliverySchedulewithParam(string? ItemNumber, string? ProjectNumber, string? PONumber, string? VendorName, string? POStatus
                                                                                                      , string? Approval, string? RecordType);
        Task<IEnumerable<podeliveryschedule_report_with_parameters_with_pagination_Dto>> GetPoDeliveryScheduleLimitwithParam(string? ItemNumber, string? ProjectNumber, string? PONumber, string? VendorName, string? POStatus
                                                                                                       , string? Approval, string? RecordType, int? Offset, int? Limit);
