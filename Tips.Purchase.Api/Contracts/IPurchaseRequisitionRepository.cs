...
namespace Tips.Purchase.Api.Contracts
{
    public interface IPurchaseRequisitionRepository : IRepositoryBase<PurchaseRequisition>
    {
        ...
        Task<IEnumerable<PurchaseRequisitionSPReportForTrans>> GetPurchaseRequisitionsSPReportWithDateForTrans(DateTime? FromDate, DateTime? ToDate, string RecordType, string Approval);
