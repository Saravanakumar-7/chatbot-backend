...
namespace Tips.Production.Api.Repository
{
    public class OQCRepository : RepositoryBase<OQC>, IOQCRepository
    {
        ...
        public OQCRepository(TipsProductionDbContext repositoryContext, AdvitaTipsProductionDbContext advitaTipsProductionDbContext, IHttpContextAccessor httpContextAccessor) : base(repositoryContext,advitaTipsProductionDbContext)
        {
