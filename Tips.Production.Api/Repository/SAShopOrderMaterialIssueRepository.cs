...
namespace Tips.Production.Api.Repository
{
    public class SAShopOrderMaterialIssueRepository : RepositoryBase<SAShopOrderMaterialIssue>, ISAShopOrderMaterialIssueRepository
    {
        ...
        public SAShopOrderMaterialIssueRepository(TipsProductionDbContext repositoryContext, AdvitaTipsProductionDbContext advitaTipsProductionDbContext, IHttpContextAccessor httpContextAccessor) : base(repositoryContext,advitaTipsProductionDbContext)
        {
