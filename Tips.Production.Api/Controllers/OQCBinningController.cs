    ...
    public class OQCBinningController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateOQCBinning([FromBody] OQCBinningPostDto oQCBinningPostDto)
        {
            ...
            try
            {
                ...
                var ItemNumbers = oQCBinningPostDto.ItemNumber;
                var encodedItemNumber = Uri.EscapeDataString(ItemNumbers);
                var ShopOrderNumber = oQCBinningPostDto.ShopOrderNumber;
                ...
                foreach (var loc in oqcBinningLocationList)
                {
                    ...
                    var request3 = new HttpRequestMessage(HttpMethod.Post, string.Concat(_config["InventoryTranctionAPI"],
            ...
            {
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in CreateOQCBinning API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.BadRequest;
                _logger.LogError($"Error Occured in CreateOQCBinning API : \n {ex.Message} \n{ex.InnerException}");
                return StatusCode(500, serviceResponse);
            }
        }
        ...
        public async Task<IActionResult> GetOQCBinningById(int id)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetOQCBinningById API for the following id : {id} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetOQCBinningById API for the following id : {id} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetAllOQCBinning([FromQuery] PagingParameter pagingParameter, [FromQuery] SearchParamess searchParamess)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetAllOQCBinning API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetAllOQCBinning API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.OK;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetOQCBinningSPReportWithParam([FromBody] OQCBinningSPReportDto oqcBinningSPReportDto)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetOQCBinningSPReportWithParam API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetOQCBinningSPReportWithParam API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        [HttpPost]
        public async Task<IActionResult> GetOQCBinningSPReportWithParamForTrans([FromBody] OQCBinningSPReportForTranDto oqcBinningSPReportDto)
        {
            ServiceResponse<IEnumerable<OQCBinningSPReport>> serviceResponse = new ServiceResponse<IEnumerable<OQCBinningSPReport>>();
            try
            {
                var products = await _oQCBinningRepository.GetOQCBinningSPReportWithParamForTrans(oqcBinningSPReportDto.ItemNumber, 
                                                                                    oqcBinningSPReportDto.ShopOrderNumber, oqcBinningSPReportDto.ProjectNumber);
            ...
            {
                _logger.LogError($"Error Occured in GetOQCBinningSPReportWithParamForTrans API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetOQCBinningSPReportWithParamForTrans API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetOQCBinningSPReportWithDate([FromQuery] DateTime? FromDate, [FromQuery] DateTime? ToDate)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetOQCBinningSPReportWithDate API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetOQCBinningSPReportWithDate API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
