...
namespace Tips.Production.Api.Controllers
{
    ...
    public class MaterialReturnNoteController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllMaterialReturnNotes([FromQuery] PagingParameter pagingParameter, [FromQuery] SearchParamess searchParamess)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetAllMaterialReturnNotes API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetAllMaterialReturnNotes API : \n {ex.Message}";
        ...
        public async Task<IActionResult> GetAllMRNOpenStatus([FromQuery] PagingParameter pagingParameter, [FromQuery] SearchParamess searchParamess)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetAllMRNOpenStatus API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetAllMRNOpenStatus API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetAllMRNOpenwithPartialStatus([FromQuery] PagingParameter pagingParameter, [FromQuery] SearchParamess searchParammes)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetAllMRNOpenwithPartialStatus API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetAllMRNOpenwithPartialStatus API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetAllMRNCloseStatus()
        {
            ...
            {
                _logger.LogError($"Error Occured in GetAllMRNCloseStatus API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetAllMRNCloseStatus API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetMaterialReturnNoteById(int id)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetMaterialReturnNoteById API for the following id : {id} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = "Error Occured in GetMaterialReturnNoteById API for the following id : {id} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> CreateMaterialReturnNote([FromBody] MaterialReturnNotePostDto materialReturnNotePostDto)
        {
            ...
            {
                _logger.LogError($"Error Occured in CreateMaterialReturnNote API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in CreateMaterialReturnNote API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> UpdateMaterialReturnNote(int id, [FromBody] MaterialReturnNoteUpdateDto materialReturnNoteUpdateDto)
        {
            ...
            {
                _logger.LogError($"Error Occured in UpdateMaterialReturnNote API for the following id : {id} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in UpdateMaterialReturnNote API for the following id : {id} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> ReturnMaterialReturnNote(int id, [FromBody] MaterialReturnNoteUpdateDto materialReturnNoteUpdateDto)
        {
            ...
            {
                _logger.LogError($"Error Occured in ReturnMaterialReturnNote API for the following id : {id} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in ReturnMaterialReturnNote API for the following id : {id} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> DeleteMaterialReturnNote(int id)
        {
            ...
            {
                _logger.LogError($"Error Occured in DeleteMaterialReturnNote API for the following id : {id} \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in DeleteMaterialReturnNote API for the following id : {id} \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetAllMaterialReturnNoteIdNameList()
        {
            ...
            {
                _logger.LogError($"Error Occured in GetAllMaterialReturnNoteIdNameList API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetAllMaterialReturnNoteIdNameList API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> SearchMaterialReturnNote([FromQuery] SearchParamess searchParams)
        {
            ...
            {
                _logger.LogError($"Error Occured in SearchMaterialReturnNote API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in SearchMaterialReturnNote API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> GetAllMaterialReturnNoteWithItems([FromBody] MaterialReturnNoteSearchDto materialReturnNote)
        {
            ...
            {
                _logger.LogError($"Error Occured in GetAllMaterialReturnNoteWithItems API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in GetAllMaterialReturnNoteWithItems API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
        ...
        public async Task<IActionResult> SearchMaterialReturnNoteDate([FromQuery] SearchDateparames searchDateParam)
        {
            ...
            {
                _logger.LogError($"Error Occured in SearchMaterialReturnNoteDate API : \n {ex.Message} \n{ex.InnerException}");
                serviceResponse.Data = null;
                serviceResponse.Message = $"Error Occured in SearchMaterialReturnNoteDate API : \n {ex.Message}";
                serviceResponse.Success = false;
                serviceResponse.StatusCode = HttpStatusCode.InternalServerError;
                return StatusCode(500, serviceResponse);
            }
